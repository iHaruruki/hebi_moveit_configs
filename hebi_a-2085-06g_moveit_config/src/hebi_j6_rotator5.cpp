...
public:
  HebiJ6Rotator() : Node("hebi_j6_rotator5") {}
  ...
  void initialize() {
    ...
    subscription_ = this->create_subscription<std_msgs::msg::Empty>( "/exec_j6_only5", 10, std::bind(&HebiJ6Rotator::rotate_j6_callback, this, std::placeholders::_1), sub_opt);
...
private:
  ...
  void rotate_j6_callback(const std_msgs::msg::Empty::SharedPtr msg) {
    ...
    if (success){
      RCLCPP_INFO(this->get_logger(), "Planning success. Executing move...");  
