...
public:
  HebiJ6Rotator() : Node("hebi_j6_rotator3") {}
  ...
  void initialize() {
    ...
    subscription_ = this->create_subscription<std_msgs::msg::Empty>( "/exec_j6_only3", 10, std::bind(&HebiJ6Rotator::rotate_j6_callback, this, std::placeholders::_1), sub_opt);
